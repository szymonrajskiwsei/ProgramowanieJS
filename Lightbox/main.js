...
function addNote(note)
{
    ...
    btnEdit.addEventListener('click', () => editNote(note, htmlContent));
}
...
function editNote(myNote, objHtmlNote)
{
    ...
    objHtmlNote.innerHTML = newContent;

    if (newContent != null) localStorage.setItem(localStorageNotesKey, JSON.stringify(notes));
}
